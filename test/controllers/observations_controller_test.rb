...
class ObservationsControllerTest < ActionController::TestCase
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post :create, observation: { comment: @observation.comment, coordinates: @observation.coordinates, description: @observation.description }
    end
  ...
  test "should update observation" do
    patch :update, id: @observation, observation: { comment: @observation.comment, coordinates: @observation.coordinates, description: @observation.description }
    assert_redirected_to observation_path(assigns(:observation))
  end
